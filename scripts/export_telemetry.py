    ...
    async with AsyncSessionLocal() as session:
        ...
        payload = {
            ...
            'model_fleet': {
                ...
                't2v_kandinsky_5_pro': 'kandinskylab/kandinsky-5',
                't2v_hunyuan_15': 'tencent/HunyuanVideo-1.5',
                't2v_ltx_23': 'Lightricks/LTX-2.3',
                't2v_wan22_a14b': 'Wan-AI/Wan2.2-T2V-A14B',
                't2v_wan22_ti2v_5b': 'Wan-AI/Wan2.2-TI2V-5B',
                't2v_wan21_14b': 'Wan-AI/Wan2.1-T2V-14B',
                't2v_wan21_13b': 'Wan-AI/Wan2.1-T2V-1.3B',
                ...
                't2v_cogvideox15_5b': 'THUDM/CogVideoX1.5-5B',
                't2v_longcat_video': 'meituan-longcat/LongCat-Video',
                't2v_allegro': 'rhymes-ai/Allegro',
                't2v_open_sora': 'hpcai-tech/Open-Sora',
                't2v_animatediff': 'guoyww/animatediff',
                't2v_animatediff_lightning': 'ByteDance/AnimateDiff-Lightning',
                't2v_pyramid_flow': 'rain1011/pyramid-flow-sd3',
                't2v_stepvideo_30b': 'stepfun-ai/stepvideo-t2v',
                't2v_ltx_video': 'Lightricks/LTX-Video',
                't2v_ltx_distilled_13b': 'Lightricks/LTX-Video-0.9.8-13B-distilled',
                't2v_modelscope_17b': 'damo-vilab/text-to-video-ms-1.7b',
                't2v_zeroscope_v2': 'cerspense/zeroscope_v2_576w',
                't2v_hotshot_xl': 'hotshotco/Hotshot-XL',
                't2v_videocrafter2': 'AILab-CVC/VideoCrafter2',
                't2v_modelscope_videocrafter': 'damo-vilab/videocrafter-diffusion',
