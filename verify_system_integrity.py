...
async def run_verification():
    ...
    try:
        ...
        results.append({'id': 10, 'name': 'Budget Guard and Cost Governor', 'status': 'PASS', 'details': f'Daily spent:  (Permit status: {can_run}).'})
        print(f'  [PASS] 10. Budget Guard and Cost Governor (Daily spent: )')
    except Exception as e:
