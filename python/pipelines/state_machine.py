...
TRANSITIONS: Dict[str, Set[str]] = {
    ...
    'APPROVED': {'UPLOAD_PENDING', 'UPLOADING', 'SCHEDULED', 'PUBLISHED', 'CANCELLED'},
    'UPLOAD_PENDING': {'UPLOADING', 'CANCELLED', 'FAILED'},
    'UPLOADING': {'PROCESSING', 'SCHEDULED', 'PUBLISHED', 'FAILED'},
    'PROCESSING': {'SCHEDULED', 'PUBLISHED', 'FAILED'},
    'SCHEDULED': {'PUBLISHED', 'UPLOADING', 'CANCELLED', 'FAILED'},
